...
private:
    ...
    void createLogicalDevice() {
        ...
        if (vulkanNode.getComponent<VulkanInstance>()->validationLayersEnabled()) {
            createInfo.enabledLayerCount = static_cast<uint32_t>(vulkanNode.getComponent<VulkanInstance>()->getValidationLayers().size());
            createInfo.ppEnabledLayerNames = vulkanNode.getComponent<VulkanInstance>()->getValidationLayers().data();
        } else {
